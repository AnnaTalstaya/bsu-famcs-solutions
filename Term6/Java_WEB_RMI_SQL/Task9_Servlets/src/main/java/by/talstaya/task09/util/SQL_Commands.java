package by.talstaya.task09.util;
...
public class SQL_Commands {
   ...
   public static final String CREATE_NOTEBOOK =
    ...
    public static final String GET_ID_MOBILE = "SELECT id\n" +
            "  FROM mobile_numbers\n" +
            "  WHERE mobile_number = (?);";
    ...
    public static final String SHOW_MOBILE_NUMBER_BY_SURNAME = "SELECT notebook.id notebook.first_name, notebook.surname, mobile_numbers.mobile_number " +
            " FROM notebook INNER JOIN mobile_numbers" +
            " ON notebook.id_mobile_number = mobile_numbers.id" +
            " WHERE surname = ?;";

    public static final String SHOW_SURNAME_BY_MOBILE_NUMBER = "SELECT notebook.id notebook.first_name, notebook.surname, mobile_numbers.mobile_number" +
            " FROM notebook INNER JOIN mobile_numbers" +
            " ON notebook.id_mobile_number = mobile_numbers.id" +
            " WHERE mobile_number = ?;";
