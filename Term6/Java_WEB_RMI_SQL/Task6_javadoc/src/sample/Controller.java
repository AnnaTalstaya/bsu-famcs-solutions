...
public class Controller {
    ...
    void addMobileNumber(ActionEvent event) throws RemoteException{
        MobileNumber mobileNumber = new MobileNumber(service.getLastIndex(SQL_Commands.GET_LAST_ID) + 1, mobileNumberTextField.getText());
    ...
    void addPerson(ActionEvent event) throws RemoteException{
        ...
        int idPerson = service.getLastIndex(SQL_Commands.GET_LAST_ID_IN_NOTEBOOK) + 1;

        if(!firstName.equals("") && !surname.equals("")){
            if(mobileNumberId != -1) {
                int mobileNumberIdInDatabase = mobileNumbers.get(mobileNumberId).getId();

                service.insertPerson(new Person(firstName, surname, mobileNumberIdInDatabase));
    ...
    void findByMobileNumber(ActionEvent event) throws RemoteException {
        ...
        List<Person> surnames = service.showSurnameByMobileNumber(mobileNumber);
